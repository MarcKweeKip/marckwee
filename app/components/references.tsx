  ...
  return (
    <Container additionalClasses="lg:px-0 md:px-0 sm:px-12 relative text-white">
      ...
      <div className="absolute w-0 top-0 md:left-[-1.5rem] left-5 md:col-start-2 sm:col-start-1 flex h-full flex-col justify-center">
        <h2 className="sticky 2xl:top-[45.5rem] xl:mt-[400px] xl:top-[38rem] sm:top-[22.5rem] lg:top-[25rem] top-[10rem] 2xl:mt-[45.5rem] mt-0 origin-left -rotate-90 transform 2xl:text-[7.5rem] xl:text-[6.25rem] lg:text-[5rem] sm:text-[4.5rem] text-[2rem] font-extrabold uppercase text-white opacity-10">
          References
        </h2>
      </div>
